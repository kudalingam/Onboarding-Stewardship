...
class Play extends Component {
  ...
  endGameComplete = () => {
    alert("Technical Round has ended!");
    const { state } = this;
    const playerStats = {
      score: state.score,
    ...
    setTimeout(() => {
      this.props.history.push("/play/technicalSummary", playerStats);
    }, 1000);
  };
  endGame = () => {
    ...
    const response = axios
      .post("http://localhost:4000/test/technical/", data)
          ...
          <div className="timer-container">
            <p>
              ...
              >
                ...
                <i className="fas fa-history ps-2" />
              </span>
            </p>
          </div>
