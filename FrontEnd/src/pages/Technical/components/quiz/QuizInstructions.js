...
import options1 from "../assets/img/options1.jpeg";

const QuizInstructions = () => (
  <>
    <div className="instructions container">
      <h1>How to Complete the Technical</h1>
      ...
      <ul className="browser-default" id="main-list">
        ...
        <li>
          Select the Answer And Go Next One
          <img src={options1} alt="Quiz App options example" />
        </li>
        <li>
      ...
      <div className="button">
        ...
        <span className="float-end">
          <Link to="/play/technical" style={{ color: "#fff" }}>
