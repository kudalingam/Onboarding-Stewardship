...
class Play extends Component {
  ...
  endGameComplete = () => {
    ...
    setTimeout(() => {
      this.props.history.push("/play/aptitudeSummary", playerStats);
    }, 1000);
  };
  endGame = () => {
    ...
    const data = {
      user_id,
      Score: ((state.score / state.numberOfQuestions) * 100).toFixed(0),
      numberOfQuestions: state.numberOfQuestions,
      numberOfAnsweredQuestions: state.correctAnswers + state.wrongAnswers,
      correctAnswers: state.correctAnswers,
      wrongAnswers: state.wrongAnswers,
    };
    // this.endGameComplete();
    console.log(data);
    const response = axios
      .post("http://localhost:4000/test/aptitude/", data)
      .then((response) => this.endGameComplete())
      .catch((error) => {
        console.error(error);
      });
  };
        ...
        <div className="questions">
          ...
          <div className="timer-container">
            <p>
              ...
              <span
                className={classnames("float-end valid", {
              ...
              >
                ...
                <i className="fas fa-history ps-2 fa-2x" />
              </span>
            </p>
          </div>
